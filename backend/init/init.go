...
import (
	...
	backendRemote "github.com/cycloidio/terraform/backend/remote"
	backendArtifactory "github.com/cycloidio/terraform/backend/remote-state/artifactory"
	backendAzure "github.com/cycloidio/terraform/backend/remote-state/azure"
	backendConsul "github.com/cycloidio/terraform/backend/remote-state/consul"
	backendCos "github.com/cycloidio/terraform/backend/remote-state/cos"
	backendEtcdv2 "github.com/cycloidio/terraform/backend/remote-state/etcdv2"
	backendEtcdv3 "github.com/cycloidio/terraform/backend/remote-state/etcdv3"
	backendGCS "github.com/cycloidio/terraform/backend/remote-state/gcs"
	backendHTTP "github.com/cycloidio/terraform/backend/remote-state/http"
	backendInmem "github.com/cycloidio/terraform/backend/remote-state/inmem"
	backendKubernetes "github.com/cycloidio/terraform/backend/remote-state/kubernetes"
	backendManta "github.com/cycloidio/terraform/backend/remote-state/manta"
	backendOSS "github.com/cycloidio/terraform/backend/remote-state/oss"
	backendPg "github.com/cycloidio/terraform/backend/remote-state/pg"
	backendS3 "github.com/cycloidio/terraform/backend/remote-state/s3"
	backendSwift "github.com/cycloidio/terraform/backend/remote-state/swift"
	backendCloud "github.com/cycloidio/terraform/cloud"
)
