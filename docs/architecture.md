...
[the `command` package](http://localhost:8080/github.com/hashicorp/terraform/command).
...
[`backendrun.Operation`](http://localhost:8080/github.com/hashicorp/terraform/backend/backendrun#Operation)
...
[`backend.Backend`](http://localhost:8080/github.com/hashicorp/terraform/backend#Backend), using a
mapping table in
[the `backend/init` package](http://localhost:8080/github.com/hashicorp/terraform/backend/init).

Backends that are able to execute operations additionally implement
[`backendrun.OperationsBackend`](http://localhost:8080/github.com/hashicorp/terraform/backend/backendrun#OperationsBackend);
...
[`local.Local`](http://localhost:8080/github.com/hashicorp/terraform/backend/local#Local),
...
(either
[`statemgr.Filesystem`](http://localhost:8080/github.com/hashicorp/terraform/states/statemgr#Filesystem) if the
...
[`terraform.Context`](http://localhost:8080/github.com/hashicorp/terraform/terraform#Context),
...
[`Plan`](http://localhost:8080/github.com/hashicorp/terraform/terraform#Context.Plan)
or
...
[package `configs`](http://localhost:8080/github.com/hashicorp/terraform/configs).
A whole configuration (the root module plus all of its descendant modules)
is represented by
[`configs.Config`](http://localhost:8080/github.com/hashicorp/terraform/configs#Config).
...
[`configload`](http://localhost:8080/github.com/hashicorp/terraform/configs/configload),
via
[`configload.Loader`](http://localhost:8080/github.com/hashicorp/terraform/configs/configload#Loader).
...
[the `statemgr` package](http://localhost:8080/github.com/hashicorp/terraform/states/statemgr),
with most practical managers implementing the full set of operations
described by
[`statemgr.Full`](http://localhost:8080/github.com/hashicorp/terraform/states/statemgr#Full)
...
The implementation
[`statemgr.Filesystem`](http://localhost:8080/github.com/hashicorp/terraform/states/statemgr#Filesystem) is used
...
[`states.State`](http://localhost:8080/github.com/hashicorp/terraform/states#State)
...
[`GraphNodeConfigResource`](http://localhost:8080/github.com/hashicorp/terraform/terraform#GraphNodeConfigResource)
...
[`terraform.GraphTransformer`](http://localhost:8080/github.com/hashicorp/terraform/terraform#GraphTransformer).
...
* [`ConfigTransformer`](http://localhost:8080/github.com/hashicorp/terraform/terraform#ConfigTransformer),
  which creates a graph vertex for each `resource` block in the configuration.

* [`StateTransformer`](http://localhost:8080/github.com/hashicorp/terraform/terraform#StateTransformer),
  which creates a graph vertex for each resource instance currently tracked
  in the state.

* [`ReferenceTransformer`](http://localhost:8080/github.com/hashicorp/terraform/terraform#ReferenceTransformer),
...
* [`ProviderTransformer`](http://localhost:8080/github.com/hashicorp/terraform/terraform#ProviderTransformer),
...
[`terraform.Graph`](http://localhost:8080/github.com/hashicorp/terraform/terraform#Graph), which
...
[the low-level `dag` package](http://localhost:8080/github.com/hashicorp/terraform/dag#AcyclicGraph.Walk)
(where "DAG" is short for [_Directed Acyclic Graph_](https://en.wikipedia.org/wiki/Directed_acyclic_graph)), in
[`AcyclicGraph.Walk`](http://localhost:8080/github.com/hashicorp/terraform/dag#AcyclicGraph.Walk).
However, the "interesting" Terraform walk functionality is implemented in
[`terraform.ContextGraphWalker`](http://localhost:8080/github.com/hashicorp/terraform/terraform#ContextGraphWalker),
...
* `EnterPath` is called once for each module in the configuration, taking a
  ...
  [`terraform.EvalContext`](http://localhost:8080/github.com/hashicorp/terraform/terraform#EvalContext)
...
[`states.SyncState`](http://localhost:8080/github.com/hashicorp/terraform/states#SyncState)
...
[`terraform.GraphNodeExecutable.Execute`](http://localhost:8080/github.com/hashicorp/terraform/terraform#GraphNodeExecutable.Execute).
...
[`terraform.BuiltinEvalContext`](http://localhost:8080/github.com/hashicorp/terraform/terraform#BuiltinEvalContext).
...
[`terraform.GraphNodeExecutable`](http://localhost:8080/github.com/hashicorp/terraform/terraform#GraphNodeExecutable),
...
* [`NodePlannableResource.Execute`](http://localhost:8080/github.com/hashicorp/terraform/terraform#NodePlannableResourceInstance.Execute), which handles the `plan` operation.

* [`NodeApplyableResourceInstance.Execute`](http://localhost:8080/github.com/hashicorp/terraform/terraform#NodeApplyableResourceInstance.Execute), which handles the main `apply` operation.

* [`NodeDestroyResourceInstance.Execute`](http://localhost:8080/github.com/hashicorp/terraform/terraform#EvalWriteState), which handles the main `destroy` operation.
...
1. Analyze the configuration expressions to see which other objects they refer
  ...
  [`lang.References`](http://localhost:8080/github.com/hashicorp/terraform/lang#References),
  or more often one of the helper wrappers around it:
  [`lang.ReferencesInBlock`](http://localhost:8080/github.com/hashicorp/terraform/lang#ReferencesInBlock)
  or
  [`lang.ReferencesInExpr`](http://localhost:8080/github.com/hashicorp/terraform/lang#ReferencesInExpr)
...
of the methods on [`lang.Scope`](http://localhost:8080/github.com/hashicorp/terraform/lang#Scope);
most commonly,
[`lang.EvalBlock`](http://localhost:8080/github.com/hashicorp/terraform/lang#Scope.EvalBlock)
or
[`lang.EvalExpr`](http://localhost:8080/github.com/hashicorp/terraform/lang#Scope.EvalExpr).
...
[`terraform.GraphNodeDynamicExpandable`](http://localhost:8080/github.com/hashicorp/terraform/terraform#GraphNodeDynamicExpandable).
